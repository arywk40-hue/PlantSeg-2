#!/bin/bash
PYTHON=/Users/ariyanbhakat/envs/plantseg-cpu/bin/python
...
CUDA_VISIBLE_DEVICES=0 $PYTHON tools/train.py configs/segnext/segnext_mscan-t_1xb16-adamw-40k_plantseg115-512x512.py
